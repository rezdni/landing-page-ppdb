...
// get data
function getUserData($database, $nis, $tabel){
    $nisCalon = htmlspecialchars($nis);
...
$dataCalon = getUserData($pdo, $_GET["nis"], "calon");
$dataOrtu = getUserData($pdo, $_GET["nis"], "orang_tua");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
